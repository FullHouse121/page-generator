...
function lpf_strings(string $lang): array {
    $dict = [
        'en' => [
            ...
            'ssl' => 'Secure & encrypted', 'verified_dev' => 'Developer',
        ...
        'es' => [
            ...
            'ssl' => 'Seguro y cifrado', 'verified_dev' => 'Desarrollador',
        ...
        'pt' => [
            ...
            'ssl' => 'Seguro e criptografado', 'verified_dev' => 'Desenvolvedor',
...
function lpf_strings_extra(): array {
    return [
        'fr' => [
            ...
            'ssl' => 'Sécurisé et chiffré', 'verified_dev' => 'Développeur',
        ...
        'de' => [
            ...
            'ssl' => 'Sicher & verschlüsselt', 'verified_dev' => 'Entwickler',
        ...
        'it' => [
            ...
            'ssl' => 'Sicura e crittografata', 'verified_dev' => 'Sviluppatore',
        ...
        'nl' => [
            ...
            'ssl' => 'Veilig en versleuteld', 'verified_dev' => 'Ontwikkelaar',
        ...
        'pl' => [
            ...
            'ssl' => 'Bezpieczna i szyfrowana', 'verified_dev' => 'Developer',
        ...
        'ro' => [
            ...
            'ssl' => 'Sigură și criptată', 'verified_dev' => 'Dezvoltator',
        ...
        'ru' => [
            ...
            'ssl' => 'Безопасно и зашифровано', 'verified_dev' => 'Разработчик',
        ...
        'tr' => [
            ...
            'ssl' => 'Güvenli ve şifreli', 'verified_dev' => 'Geliştirici',
        ...
        'id' => [
            ...
            'ssl' => 'Aman & terenkripsi', 'verified_dev' => 'Developer',
        ...
        'vi' => [
            ...
            'ssl' => 'An toàn & được mã hóa', 'verified_dev' => 'Nhà phát triển',
        ...
        'th' => [
            ...
            'ssl' => 'ปลอดภัยและเข้ารหัส', 'verified_dev' => 'นักพัฒนา',
        ...
        'hi' => [
            ...
            'ssl' => 'सुरक्षित और एन्क्रिप्टेड', 'verified_dev' => 'डेवलपर',
        ...
        'ko' => [
            ...
            'ssl' => '안전하고 암호화됨', 'verified_dev' => '개발자',
        ...
        'ar' => [
            ...
            'ssl' => 'آمن ومشفّر', 'verified_dev' => 'المطوّر',
